...
namespace AnimalsDirectory
{
    ...
    public sealed partial class DetailPage : Page
    {
        private static DependencyProperty s_itemProperty
            = DependencyProperty.Register("Item", typeof(Animal), typeof(DetailPage), new PropertyMetadata(null));
        ...
        public Animal Item
        {
            get { return (Animal)GetValue(s_itemProperty); }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Item = AnimalsDataSource.GetItemById((int)e.Parameter);
